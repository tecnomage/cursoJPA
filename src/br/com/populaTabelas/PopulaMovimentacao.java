...
public class PopulaMovimentacao {
	...
	public static void main(String[] args) {
		...
		Conta conta1 = manager.find(Conta.class,11);
		Conta conta2 = manager.find(Conta.class,11);
		Conta conta3 = manager.find(Conta.class,11);
		Conta conta4 = manager.find(Conta.class,1);
		Conta conta5 = manager.find(Conta.class,11);
